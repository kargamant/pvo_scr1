...
1. **direction**: будет ли условная ветка взята? - **BHT** (+ BTFN
   как статический дефолт).
2. **target**: если взят -куда? - **BTB** для прямых целей, **RAS** для
   возвратов (косвенных).
...
**1. Выборка (комбинация BTB и BHT).**
...
**2. Поздний этап прогноза (BTFN, BHT и RAS).**
