...
module scr1_icache #(
    ...
    parameter int unsigned                  NUM_LINES              = SCR1_ICACHE_NUM_LINES,
    parameter int unsigned                  LINE_WORDS             = SCR1_ICACHE_LINE_WORDS
) (
    input  logic                              clk,
    input  logic                              rst_n,
...
`ifdef SCR1_CACHE_PERF_COUNTERS
    ...
    assign perf_invalidate_event = (state_q == IC_IDLE) && invalidate_i;
`endif // SCR1_CACHE_PERF_COUNTERS
